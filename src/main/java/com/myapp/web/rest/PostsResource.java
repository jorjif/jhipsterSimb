    ...
    public ResponseEntity<Posts> partialUpdatePosts(
        ...
        Optional<Posts> result = postsRepository
            ...
            .map(existingPosts -> {
                ...
                if (posts.getViews() != null) {
                    existingPosts.setViews(posts.getViews());
                }
                if (posts.getImg() != null) {
                    existingPosts.setImg(posts.getImg());
                }
                if (posts.getImgContentType() != null) {
                    existingPosts.setImgContentType(posts.getImgContentType());
                }
