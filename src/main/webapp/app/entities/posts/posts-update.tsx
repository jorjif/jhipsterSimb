...
export const PostsUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...postsEntity,
          date: convertDateTimeFromServer(postsEntity.date),
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterApp.posts.title')}
                id="posts-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.posts.content')}
                id="posts-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.posts.date')}
                id="posts-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.posts.views')}
                id="posts-views"
                name="views"
                data-cy="views"
                type="text"
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterApp.posts.img')}
                id="posts-img"
                name="img"
                data-cy="img"
                isImage
