...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIEWPERDATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIEWPERDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIEWPERDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIEWPERDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIEWPERDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIEWPERDATE actions', async () => {
      const expectedActions = [
        {
