...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIEWSTODATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIEWSTODATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIEWSTODATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIEWSTODATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIEWSTODATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIEWSTODATE actions', async () => {
      const expectedActions = [
        {
