...
class PostResourceIT {
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getImg()).isEqualTo(DEFAULT_IMG);
        assertThat(testPost.getImgContentType()).isEqualTo(DEFAULT_IMG_CONTENT_TYPE);
    }
    ...
    void putExistingPost() throws Exception {
        ...
        assertThat(testPost.getImg()).isEqualTo(UPDATED_IMG);
        assertThat(testPost.getImgContentType()).isEqualTo(UPDATED_IMG_CONTENT_TYPE);
    }
